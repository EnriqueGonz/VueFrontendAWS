    ...
    <div class="contenedor">
        ...
        <div class="boton">
            <div class="btn-group" role="group">
                <button type="button" class="btn btn-dark" style="margin-left: 30px; width:90px;" @click="regresar">Regresar</button>
                <button type="button" class="btn btn-success" style="margin-left: 50px" @click="registrar">Registrarse</button>
            </div>
        </div>
        </form>
    </div>
